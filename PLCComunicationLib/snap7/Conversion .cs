...
namespace PLCComunicationLib.snap7
{
    /// <summary>
    ...
    public static class Conversion
    {
        ...
        {
            uint output;
            output = PLCComunicationLib.snap7.Types.DWord.FromByteArray(PLCComunicationLib.snap7.Types.Double.ToByteArray(input));
            return output;
        }
        ...
        {
            double output;
            output = PLCComunicationLib.snap7.Types.Double.FromByteArray(PLCComunicationLib.snap7.Types.DWord.ToByteArray(input));
            return output;
        }
    }
